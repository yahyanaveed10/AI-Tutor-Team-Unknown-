...
class DatabaseService:
    """Persists student state to individual JSON files (parallel-safe)."""
    ...
    def save_state(self, state: StudentState):
        ...
        path = self._state_path(state.student_id)
